...
public class DatabaseHandler_in_ve extends SQLiteOpenHelper {
    ...
    // insert data
    public void insertUserInfo(String name, String mobile, String email) {
        ...
        values.put(KEY_USERINFO_email,email);
